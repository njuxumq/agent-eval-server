...
- [任务管理器设计](details/scheduler/任务管理器设计.md) - TaskManager 实现细节
- [任务拆分器设计](details/scheduler/任务拆分器设计.md) - TaskSplitter 实现细节
- [DAG构建器设计](details/scheduler/DAG构建器设计.md) - DAGBuilder 实现细节
- [事件总线设计](details/scheduler/事件总线设计.md) - EventBus 实现细节
- [DAG调度器设计](details/scheduler/DAG调度器设计.md) - DAGScheduler 实现细节
